...
export async function GET(context: APIContext): Promise<Response> {
  ...
  try {
    ...
    const subject = `CAN Daily: ${calls} calls, ${fmtCost(cost)}, ${users} users`;
...
<div style="max-width:640px;margin:24px auto;background:#161b22;border:1px solid #30363d;border-radius:12px;overflow:hidden;">
  <div style="background:linear-gradient(135deg,#0D7377,#095456);padding:20px 24px;">
    ...
    <div style="font-size:12px;color:rgba(255,255,255,0.7);margin-top:2px;">Discover Canada &middot; Last 24 Hours</div>
  </div>
  ...
  <div style="padding:12px 24px;text-align:center;font-size:11px;color:#484f58;border-top:1px solid #21262d;">
    Claude Haiku 4.5 &middot; <a href="https://discoveringcanada.info/api/admin/stats?key=${key}" style="color:#0D7377;text-decoration:none;">Full Dashboard</a>
  </div>
</div>
</body></html>`;
