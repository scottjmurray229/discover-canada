  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(135deg,#0D7377,#14B8A6);padding:32px 28px;text-align:center;">
        <h1 style="color:white;font-size:24px;margin:0 0 8px;">Discover Canada</h1>
      ...
      <div style="padding:28px;">
        <p style="color:#1A2332;font-size:16px;line-height:1.65;margin:0 0 16px;">
          Salamat! You're now part of the Discover Canada community.
        </p>
        ...
        <p style="color:#4a4a5e;margin-bottom:12px;font-size:15px;">
          I use Hotels.com for Canada &#8212; earn a free night after every 10 stays.
        ...
        <div style="text-align:center;margin-bottom:20px;">
          <a href="https://hotels.com/affiliate?camref=1101l5Eohj&creativeref=1011l66481&adref=welcome-email"
            ...
            Browse Canada Hotels &rarr;
          </a>
        </div>

        <div style="text-align:center;margin-bottom:24px;">
          <a href="https://discoveringcanada.info/destinations/" style="display:inline-block;background:#0D7377;color:white;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:15px;">Browse All Destinations</a>
        </div>
    ...
    <p style="color:#94A3B8;font-size:11px;text-align:center;margin:20px 0 0;line-height:1.5;">
      You're receiving this because you signed up at discoveringcanada.info.<br>
      <a href="https://discoveringcanada.info/legal/privacy/" style="color:#94A3B8;">Privacy Policy</a>
    </p>
  </div>
</body>
</html>`;
...
async function sendWelcomeEmail(apiKey: string, to: string, guideName: string): Promise<void> {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'Discover Canada <hello@discovermore.travel>',
      to: [to],
      reply_to: 'info@discovermore.travel',
      subject: `Your ${guideName} — Welcome to Discover Canada`,
