...
export const NETWORK_SITES: NetworkSite[] = [
  ...
  // Southeast Asia
  { id: 'canada', name: 'Discovering Canada', shortName: 'Canada', domain: 'discoveringcanada.info', url: 'https://discoveringcanada.info', flag: '\u{1F1E8}\u{1F1E6}', region: 'us-west', status: 'live', tagline: 'Mountains, cities, and wilderness across 12 iconic destinations' },
...
export const CURRENT_SITE_ID = 'canada';
