...
// ============================================================
// DESTINATION COLLECTION — PDD §4.1
// The core content type: immersive island/city guides
// ============================================================
const destinations = defineCollection({
  ...
  schema: z.object({
    ...
    region: z.enum(['west', 'central', 'east', 'north']),
...
// ============================================================
// BLOG COLLECTION — PDD §3.11
// SEO-targeted articles, travel guides, practical content
// ============================================================
