...
description: "Anne of Green Gables country — red sand beaches, lobster suppers, cycling the Confederation Trail, and pastoral landscapes in Canada's smallest province."
region: east
heroVideo: ""
heroImage: ""
...
budgetPerDay:
  ...
  midRange: 130
  luxury: 280
gettingThere: "Fly into Charlottetown Airport (YYG) with connections through Toronto, Halifax, and Montreal. Confederation Bridge (13km, $50.25 CAD per vehicle return) connects New Brunswick to PEI. Northumberland Ferries from Caribou, NS to Wood Islands, PEI ($94.25 CAD per vehicle return, May-December)."
essentials:
  - { icon: "💰", label: "Currency", value: "CAD (Canadian Dollar). $1 USD ≈ $1.36 CAD" }
  - { icon: "🌡️", label: "Climate", value: "Maritime climate. Warm summers (22-25°C), cold winters. Ocean-warmed air softens extremes" }
  - { icon: "🗣️", label: "Language", value: "English. French spoken in Evangeline region (west PEI)" }
  - { icon: "📶", label: "Connectivity", value: "Good coverage in Charlottetown and main towns. Rural areas can be patchy" }
  - { icon: "🚗", label: "Transport", value: "Car essential outside Charlottetown. Bike rental for Confederation Trail sections" }
  - { icon: "⏰", label: "Time Zone", value: "ADT (UTC-3) summer, AST (UTC-4) winter" }
gradientColors: "from-red-900 via-rose-800 to-green-900"
highlights:
  - "Green Gables Heritage Place — the farm that inspired Anne of Green Gables"
  - "Cavendish Beach — PEI National Park's iconic red sand beaches"
  - "Confederation Trail — 470km cycling trail across the entire island"
  - "Fresh lobster suppers — church hall lobster suppers, a PEI tradition since the 1950s"
  - "Red clay roads — the distinctive iron oxide soil that defines the island's character"
relatedDestinations:
  - slug: "montreal"
    hook: "Fly or drive to Montreal for urban contrast"
  - slug: "ottawa"
    hook: "Discover Canada's capital from the Maritimes"
faqItems:
  - question: "What is a PEI lobster supper?"
    answer: "Church hall lobster suppers have been a PEI tradition since the 1950s, when church communities raised funds through community dinners. You sit at long tables, receive a whole lobster (typically 1.25-1.5 lbs), chowder, mussels, rolls, salad, and dessert for $50-65 CAD. St. Ann's Church Lobster Suppers in Hunter River is the most famous."
  - question: "Is PEI worth visiting without kids?"
    answer: "Absolutely. The Anne of Green Gables angle draws families but the real PEI — cycling, oyster festivals, coastal food, pastoral scenery, north shore beaches — is compelling for any traveller. The Confederation Trail is the finest recreational cycling in Canada."
  - question: "When do lobster suppers operate?"
    answer: "Traditional church hall lobster suppers typically run June through October. Commercial lobster supper restaurants operate May through November. Lobster season in PEI is May-June and August-October (two seasons), with the freshest lobster during these windows."
  - question: "What is the Confederation Trail?"
    answer: "A 470km multi-use trail across the entire length of PEI, built on a converted railway right-of-way. Flat, crushed limestone surface, ideal for recreational cycling. You can cycle end-to-end in 3-5 days or ride sections. Bike rentals available in most towns."
affiliatePicks:
  - name: "Inn at Bay Fortune"
    type: "hotel"
    price: "$250-450 CAD/night"
    personalNote: "Iconic PEI inn with the extraordinary FireWorks dinner — chef Michael Smith's theatrical farm-to-table experience. Worth the splurge."
    affiliateUrl: "https://www.booking.com/hotel/ca/inn-at-bay-fortune.html?aid=2778866"
    badge: "Scott's Pick"
  - name: "Charlottetown Inn and Conference Centre"
    type: "hotel"
    price: "$120-220 CAD/night"
    personalNote: "Reliable mid-range choice in Charlottetown's downtown with parking. Good base for island exploration."
    affiliateUrl: "https://www.booking.com/hotel/ca/charlottetown-inn.html?aid=2778866"
  - name: "St. Ann's Church Lobster Supper"
    type: "activity"
    price: "$60-70 CAD per person"
    personalNote: "The original lobster supper, running since 1964. Whole lobster, chowder, mussels, salads, and homemade pies. The most authentic PEI food experience."
    affiliateUrl: "https://www.stannschurchlobstersupper.com"
