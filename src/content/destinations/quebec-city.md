---
title: "Quebec City"
description: "North America's only walled city north of Mexico — UNESCO-listed Old Quebec, Chateau Frontenac, French culture, and the world-famous Winter Carnival."
region: east
heroVideo: ""
heroImage: ""
...
budgetPerDay:
  ...
  midRange: 150
  luxury: 350
gettingThere: "Jean Lesage International Airport (YQB) is 15 minutes from Old Quebec. VIA Rail from Montreal takes 3 hours ($45-100 CAD). Driving from Montreal is 2.5 hours via Autoroute 20."
essentials:
  - { icon: "💰", label: "Currency", value: "CAD (Canadian Dollar). $1 USD ≈ $1.36 CAD" }
  - { icon: "🌡️", label: "Climate", value: "Hot summers (25°C), dramatically cold winters (-15°C and below)" }
  - { icon: "🗣️", label: "Language", value: "French primary. English understood in tourist areas but French is appreciated" }
  - { icon: "📶", label: "Connectivity", value: "Good LTE coverage. Free WiFi in most cafes and hotels" }
  - { icon: "🚶", label: "Transport", value: "Old City is walkable. Funicular connects Upper Town to Lower Town ($4 CAD)" }
  - { icon: "⏰", label: "Time Zone", value: "EDT (UTC-4) summer, EST (UTC-5) winter" }
gradientColors: "from-red-900 via-stone-800 to-amber-900"
highlights:
  - "Old Quebec — UNESCO World Heritage site with 400+ years of history"
  - "Chateau Frontenac — the world's most photographed hotel"
  - "Plains of Abraham — where the 1759 battle changed North American history"
  - "Petit-Champlain — North America's oldest commercial district"
  - "Quebec Winter Carnival — the world's largest winter carnival each February"
relatedDestinations:
  - slug: "montreal"
    hook: "VIA Rail to Montreal for bilingual urban energy"
  - slug: "ottawa"
    hook: "Drive to Ottawa for Parliament Hill and national museums"
faqItems:
  - question: "Is Quebec City really that French?"
    answer: "Yes — French is the official language and daily life operates in French. In tourist areas (Old City), English is widely spoken, but making an effort with basic French phrases is genuinely appreciated and will get you warmer service."
  - question: "When is the Quebec Winter Carnival?"
    answer: "Usually the last week of January through the first week of February. It's the world's largest winter carnival — ice sculptures, a bonhomme mascot, night parades, and ice canoe racing on the St. Lawrence."
  - question: "How do I get between Upper and Lower Town?"
    answer: "The funicular on Terrasse Dufferin runs year-round ($4 CAD one-way). You can also walk down the steep Breakneck Stairs — free, dramatic, not for bad knees."
  - question: "Do I need a car in Quebec City?"
    answer: "No. Old Quebec is entirely walkable. The Plains of Abraham are a short walk or cheap taxi. A car helps for day trips to Montmorency Falls (15 min) or Ile d'Orleans (30 min)."
affiliatePicks:
  - name: "Chateau Frontenac"
    type: "hotel"
    price: "$350-800 CAD/night"
    personalNote: "THE experience in Quebec City. Book a St. Lawrence River-view room. The afternoon tea is exceptional."
    affiliateUrl: "https://www.booking.com/hotel/ca/fairmont-le-chateau-frontenac.html?aid=2778866"
    badge: "Scott's Pick"
  - name: "Hotel du Vieux-Quebec"
    type: "hotel"
    price: "$150-280 CAD/night"
    personalNote: "Charming boutique hotel in Old Quebec. Perfect location, friendly staff, good breakfast."
    affiliateUrl: "https://www.booking.com/hotel/ca/du-vieux-quebec.html?aid=2778866"
  - name: "Plains of Abraham Cycling Tour"
    type: "activity"
    price: "$65 CAD"
    personalNote: "Cycle the Battlefield Park with an English-speaking guide. Historical context makes the visit come alive."
    affiliateUrl: "https://www.klook.com/en-US/search/result/?query=Quebec+City+bike+tour"
