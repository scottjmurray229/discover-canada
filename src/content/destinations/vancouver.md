---
title: "Vancouver"
description: "A Pacific metropolis where mountains meet ocean — Stanley Park, Granville Island, and one of the world's most livable cities."
region: west
heroVideo: ""
heroImage: ""
...
budgetPerDay:
  ...
  midRange: 180
  luxury: 400
gettingThere: "Vancouver International Airport (YVR) has direct flights from most major cities. SkyTrain Canada Line connects the airport to downtown in 25 minutes ($4.55 CAD)."
essentials:
  - { icon: "💰", label: "Currency", value: "CAD (Canadian Dollar). $1 USD ≈ $1.36 CAD" }
  - { icon: "🌡️", label: "Climate", value: "Mild year-round. Rainy Oct-May (8-12°C), sunny and warm Jun-Sep (20-26°C)" }
  - { icon: "🗣️", label: "Language", value: "English. Mandarin and Cantonese widely spoken in Richmond" }
  - { icon: "📶", label: "Connectivity", value: "Excellent LTE/5G coverage throughout the city and most parks" }
  - { icon: "🚗", label: "Transport", value: "SkyTrain + buses + SeaBus. Car needed only for day trips" }
  - { icon: "⏰", label: "Time Zone", value: "PDT (UTC-7) summer, PST (UTC-8) winter" }
gradientColors: "from-emerald-900 via-teal-800 to-blue-900"
highlights:
  - "Stanley Park — 1,001 acres of old-growth forest with a seawall to die for"
  - "Granville Island Market — artisan food, fresh seafood, and local crafts"
  - "Capilano Suspension Bridge — 137m across, 70m above the canyon"
  - "Gastown — cobblestone streets, steam clock, and Vancouver's hippest restaurants"
  - "Whistler day trip — world-class ski resort 2 hours north on the Sea-to-Sky"
relatedDestinations:
  - slug: "whistler"
    hook: "Day trip or weekend to Whistler via Sea-to-Sky Highway"
  - slug: "victoria"
    hook: "Ferry to Vancouver Island and Victoria"
faqItems:
  - question: "Is Vancouver rainy?"
    answer: "Yes, from October through April. Pack a good rain jacket. June through September is reliably sunny and warm — this is the best time to visit."
  - question: "How do I get around Vancouver without a car?"
    answer: "Easily. The SkyTrain covers downtown, Richmond, Surrey, and the airport. Buses and SeaBus to North Vancouver fill the gaps. A day pass is $11.25 CAD."
  - question: "What's the best neighbourhood to stay in?"
    answer: "Downtown and Yaletown for walkability. Kitsilano for a beach-neighbourhood vibe. Gastown for boutique hotels and nightlife."
  - question: "Can I do a day trip to Whistler from Vancouver?"
    answer: "Yes — it's 2 hours north on the Sea-to-Sky Highway, one of the world's most scenic drives. Allow at least one full day, ideally stay overnight."
affiliatePicks:
  - name: "Rosewood Hotel Georgia"
    type: "hotel"
    price: "$350-700 CAD/night"
    personalNote: "The grand dame of Vancouver hotels. Central location, beautiful rooms, impeccable service."
    affiliateUrl: "https://www.booking.com/hotel/ca/rosewood-hotel-georgia.html?aid=2778866"
    badge: "Scott's Pick"
  - name: "Samesun Vancouver Hostel"
    type: "hotel"
    price: "$40-70 CAD/night"
    personalNote: "Best hostel in downtown Vancouver. Rooftop bar, lively crowd, steps from everything."
    affiliateUrl: "https://www.booking.com/hotel/ca/samesun-vancouver.html?aid=2778866"
  - name: "Capilano Suspension Bridge Park"
    type: "activity"
    price: "$64 CAD/adult"
    personalNote: "Pricey but genuinely spectacular. TreeTops Adventure and Cliffwalk included. Buy online to skip queues."
    affiliateUrl: "https://www.klook.com/en-US/search/result/?query=Capilano+Suspension+Bridge"
