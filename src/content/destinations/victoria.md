---
title: "Victoria"
description: "Butchart Gardens, afternoon tea at the Empress, whale watching in the Salish Sea, and Canada's mildest year-round climate on Vancouver Island."
region: west
heroVideo: ""
heroImage: ""
...
budgetPerDay:
  ...
  midRange: 160
  luxury: 350
gettingThere: "BC Ferries from Tsawwassen (Vancouver) to Swartz Bay — 90-minute crossing, $18.90 CAD per passenger. Harbour Air floatplane from Vancouver downtown to Victoria Inner Harbour — 35 minutes, $120-200 CAD. Fly into Victoria International Airport (YYJ)."
essentials:
  - { icon: "💰", label: "Currency", value: "CAD (Canadian Dollar). $1 USD ≈ $1.36 CAD" }
  - { icon: "🌡️", label: "Climate", value: "Canada's mildest climate. Rarely below 0°C in winter. Warm, dry summers (22-26°C)" }
  - { icon: "🗣️", label: "Language", value: "English" }
  - { icon: "📶", label: "Connectivity", value: "Excellent coverage throughout. Free WiFi at Inner Harbour and most cafes" }
  - { icon: "🚲", label: "Transport", value: "Very cycle-friendly. Excellent bike lanes. BC Transit buses. Ferry to downtown" }
  - { icon: "⏰", label: "Time Zone", value: "PDT (UTC-7) summer, PST (UTC-8) winter" }
gradientColors: "from-green-900 via-emerald-800 to-teal-900"
highlights:
  - "Butchart Gardens — 55 acres of spectacular themed gardens in a former limestone quarry"
  - "Fairmont Empress afternoon tea — a Victoria institution since 1908"
  - "Whale watching — orcas, minke whales, and humpbacks in the Salish Sea"
  - "Inner Harbour — the heart of the city, with the Empress and Parliament Buildings"
  - "Cycling culture — extensive trails including the Galloping Goose Regional Trail"
relatedDestinations:
  - slug: "vancouver"
    hook: "BC Ferries back to Vancouver"
  - slug: "whistler"
    hook: "Continue to Whistler from Vancouver"
faqItems:
  - question: "How do I get from Vancouver to Victoria?"
    answer: "BC Ferries from Tsawwassen to Swartz Bay — 90 minutes, $18.90 CAD per person (more with a car). Harbour Air floatplane from downtown Vancouver to Inner Harbour — 35 minutes, $120-200 CAD one way. Both are scenic; the ferry is more affordable."
  - question: "Is the Butchart Gardens worth the price?"
    answer: "Yes. The $40-47 CAD admission covers 55 acres of meticulously maintained themed gardens in a 100-year-old limestone quarry. Saturday summer evenings include fireworks and live entertainment. Go late afternoon to catch both daylight and the evening illumination."
  - question: "Can I see orcas from Victoria?"
    answer: "Yes — the Salish Sea is home to resident and transient orca pods, plus minke and humpback whales. Whale watching tours run May through October ($120-150 CAD). Best months are May-September. Resident orcas are seen more reliably than transient pods."
  - question: "How many days do I need in Victoria?"
    answer: "Two to three days covers the main highlights. Three to four days allows for Butchart Gardens, a day of cycling, whale watching, and proper exploration of the food scene."
affiliatePicks:
  - name: "Fairmont Empress Hotel"
    type: "hotel"
    price: "$300-700 CAD/night"
    personalNote: "The Empress defines Victoria. Even if you don't stay, do afternoon tea ($100 CAD per person) in the Tea Lobby. Iconic."
    affiliateUrl: "https://www.booking.com/hotel/ca/fairmont-empress.html?aid=2778866"
    badge: "Scott's Pick"
  - name: "Hotel Grand Pacific"
    type: "hotel"
    price: "$180-320 CAD/night"
    personalNote: "Excellent mid-range option on the Inner Harbour. Pool and fitness centre, walking distance to everything."
    affiliateUrl: "https://www.booking.com/hotel/ca/grand-pacific.html?aid=2778866"
  - name: "Prince of Whales Whale Watching"
    type: "activity"
    price: "$135 CAD/adult"
    personalNote: "Victoria's most reputable whale watching operator. Rigid inflatable boats get you closest to the wildlife. Book ahead in July and August."
    affiliateUrl: "https://www.klook.com/en-US/search/result/?query=Victoria+whale+watching"
