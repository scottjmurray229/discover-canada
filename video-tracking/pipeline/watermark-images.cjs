 ...
 *
 * Uses FFmpeg drawtext to overlay "discoveringcanada.info" on all JPG/PNG images.
...
function watermarkFilter(fontsize) {
  return `drawtext=text='discoveringcanada.info':fontsize=${fontsize}:fontcolor=white@0.8:shadowcolor=black@0.6:shadowx=2:shadowy=2:x=w-tw-20:y=h-th-20:fontfile='${FONT_PATH}'`;
}
